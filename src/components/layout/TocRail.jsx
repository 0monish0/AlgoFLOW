...
export const TocRail = ({ sections = [], slug, title, customGif, media, isCollapsed = false }) => {
  ...
  return (
    <aside
      className={`hidden xl:block shrink-0 font-mono select-none sticky top-16 h-[calc(100vh-4rem)] self-start overflow-y-auto pl-4 2xl:pl-6 pr-0 py-2 z-20 transition-[width] duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] ${
        isCollapsed ? 'w-full xl:w-[35%]' : 'w-full xl:w-[42%]'
      }`}
    >
